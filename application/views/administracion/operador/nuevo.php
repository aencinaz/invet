  ...
  <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Nuevo Operador</h1>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            ...
            <?php echo form_open(base_url()."operador/nuevo") ?>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" autocomplete="off" name="apellido" type="text">
                </div>
